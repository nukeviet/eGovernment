 ...
 * @Createdate Thu, 22 Feb 2018 02:54:01 GMT
 */
...
$sql_create_table[] = "REPLACE INTO `" . $db_config['prefix'] . "_config` (`lang`, `module`, `config_name`, `config_value`) VALUES ('sys', 'global', 'timestamp', '47')";
...
$sql_create_table[] = "REPLACE INTO `" . $db_config['prefix'] . "_config` (`lang`, `module`, `config_name`, `config_value`) VALUES ('vi', 'global', 'cronjobs_next_time', '1519268240')";
...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_cronjobs` (`id`, `start_time`, `inter_val`, `run_file`, `run_func`, `params`, `del`, `is_sys`, `act`, `last_time`, `last_result`, `vi_cron_name`) VALUES (1, 1498555144, 5, 'online_expired_del.php', 'cron_online_expired_del', '', 0, 1, 1, 1519267940, 1, 'Xóa các dòng ghi trạng thái online đã cũ trong CSDL')";
...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_setup_extensions` (`id`, `type`, `title`, `is_sys`, `is_virtual`, `basename`, `table_prefix`, `version`, `addtime`, `author`, `note`) VALUES (0, 'module', 'faq', 0, 1, 'faq', 'faq', '4.3.01 1517475600', 1498555548, 'VINADES (contact@vinades.vn)', '')";
...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_setup_extensions` (`id`, `type`, `title`, `is_sys`, `is_virtual`, `basename`, `table_prefix`, `version`, `addtime`, `author`, `note`) VALUES (0, 'module', 'laws', 0, 1, 'laws', 'laws', '4.3.01 1517475600', 1498555548, 'VINADES (contact@vinades.vn)', 'Modules văn bản pháp luật')";
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_setup_extensions` (`id`, `type`, `title`, `is_sys`, `is_virtual`, `basename`, `table_prefix`, `version`, `addtime`, `author`, `note`) VALUES (0, 'theme', 'egov', 0, 0, 'egov', 'egov', '1.0.05 1510912800', 1510912800, 'VINADES (contact@vinades.vn)', 'egov')";
...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_setup_extensions` (`id`, `type`, `title`, `is_sys`, `is_virtual`, `basename`, `table_prefix`, `version`, `addtime`, `author`, `note`) VALUES (0, 'module', 'organs', 0, 1, 'organs', 'organs', '4.3.01 1517475600', 1506565060, 'VINADES (contact@vinades.vn)', '')";
...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_setup_extensions` (`id`, `type`, `title`, `is_sys`, `is_virtual`, `basename`, `table_prefix`, `version`, `addtime`, `author`, `note`) VALUES (0, 'theme', 'mobile_egov', 0, 0, 'mobile_egov', 'mobile_egov', '1.0.05 1510912800', 1510912800, 'VINADES (contact@vinades.vn)', 'Đây là giao diện mặc định cho mobile')";
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_setup_extensions` (`id`, `type`, `title`, `is_sys`, `is_virtual`, `basename`, `table_prefix`, `version`, `addtime`, `author`, `note`) VALUES (0, 'module', 'videoclips', 0, 1, 'videoclips', 'videoclips', '4.3.01 1517475600', 1510884305, 'VINADES (contact@vinades.vn)', 'Module playback of video-clips')";

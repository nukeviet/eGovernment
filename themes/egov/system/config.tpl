    ...
    <div>
        <form action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
            <div class="col-sm-12 col-xs-12 col-md-12">
                ...
                <span>{LANG.layout_orange}</span> <input type="checkbox" name="color_default[]" value="1" {THEME_COLOR_CHECKED_1}>
                </div>        
            </div>
            <div class="col-sm-12 col-xs-12 col-md-12">
                <div class="img-color">
                 ...
                 <div class="text-layout">
                <span>{LANG.layout_blue}</span> <input type="checkbox" name="color_default[]" value="2" {THEME_COLOR_CHECKED_2}>
                </div>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-12">
                <div class="img-color">
                ...
                <div class="text-layout">
                <span>{LANG.layout_green}</span> <input type="checkbox" name="color_default[]" value="3" {THEME_COLOR_CHECKED_3}>
                </div>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-12">
                <div class="img-color">
                 ...
                 <div class="text-layout">
                <span>{LANG.layout_light_brown}</span> <input type="checkbox" name="color_default[]" value="4"  {THEME_COLOR_CHECKED_4}>
                </div>
            </div>

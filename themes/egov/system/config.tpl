                        ...
                        <tr>
                            <td style="padding-left: 50px; width: 50%">
                                ...
                                <div class="text-layout">
                                    <label><span>{LANG.layout_orange}</span> <input type="checkbox" name="color_default[]" value="1"{THEME_COLOR_CHECKED_1}></label>
                                </div>
                            </td>
                            <td style="padding-left: 50px; width: 50%;">
                                <div class="img-color">
                                ...
                                <div class="text-layout">
                                    <label><span>{LANG.layout_blue}</span> <input type="checkbox" name="color_default[]" value="2"{THEME_COLOR_CHECKED_2}></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-left: 50px; width: 50%"><div class="img-color">
                                ...
                                <div class="text-layout">
                                    <label><span>{LANG.layout_green}</span> <input type="checkbox" name="color_default[]" value="3"{THEME_COLOR_CHECKED_3}></label>
                                </div></td>
                            <td style="padding-left: 50px; width: 50%">
                                <div class="img-color">
                                ...
                                <div class="text-layout">
                                    <label><span>{LANG.layout_light_brown}</span> <input type="checkbox" name="color_default[]" value="4"{THEME_COLOR_CHECKED_4}></label>
                                </div>
                            </td>
                        </tr>
                        <tr>

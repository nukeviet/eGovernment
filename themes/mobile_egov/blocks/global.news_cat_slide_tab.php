...
if (!nv_function_exists('nv_block_news_cat_slide_tab')) {
    ...
    function nv_block_config_news_cat_slide_tab($module, $data_block, $lang_block)
    {
        ...
        if ($nv_Request->isset_request('loadajaxdata', 'get')) {
            ...
            $html .= '<div class="col-sm-18"><div class="checkbox"><label>';
            $html .= '<input type="checkbox" value="1" name="config_showtooltip" ' . ($data_block['showtooltip'] == 1 ? 'checked="checked"' : '') . ' /></label></div>';
    ...
    function nv_block_config_news_cat_slide_tab_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    function nv_block_news_cat_slide_tab($block_config)
    {
        global $site_mods;
        ...
        if (isset($site_mods[$module])) {
            ...
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.news_cat_slide_tab.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.news_cat_slide_tab.tpl')) {
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_news_cat_slide_tab($block_config);
}
